...
unsigned long ecall_3(unsigned long which, unsigned long arg0, unsigned long arg1, unsigned long arg2) {
    register unsigned long a1 asm ("a1") = (unsigned long)(arg0);
    register unsigned long a2 asm ("a2") = (unsigned long)(arg1);
    register unsigned long a3 asm ("a3") = (unsigned long)(arg2);
    register unsigned long a0 asm ("a0") = (unsigned long)(which);
    asm volatile ("ecall"
              : "+r" (a0)
              : "r"  (a1), "r" (a2), "r" (a3)
              : "memory");
...
void main(void)
{
    ...
    ecall_1(SYS_PUTS, (unsigned long) "World!\n");
